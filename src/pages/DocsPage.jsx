...
const DOCS_DATA = [
  {
    ...
    description: 'Nuestra herramienta estrella. Realiza una limpieza automática de todo el dataset con un solo clic.',
    features: [
      { name: 'Auto-Limpieza', desc: 'Ejecuta secuencialmente: 1. Elimina espacios en blanco (Trim) en textos. 2. Elimina filas completamente vacías. 3. Elimina filas duplicadas exactas.' }
    ]
  },
  {
    id: 'structure',
    ...
    description: 'Herramientas para modificar la forma de la tabla (filas y columnas).',
    features: [
      { name: 'Promover Encabezados', desc: 'Convierte la primera fila de datos en los nombres de las columnas. Útil cuando importas CSVs sin header.' },
      { name: 'Agregar Índice', desc: 'Crea una nueva columna al inicio con un número consecutivo (1, 2, 3...) para cada fila.' },
      { name: 'Duplicar Columna', desc: 'Crea una copia exacta de la columna seleccionada. Útil para guardar el original antes de transformarlo.' },
      { name: 'Eliminar Filas Superiores', desc: 'Borra las primeras "N" filas de la tabla. Útil para eliminar títulos o metadatos basura al inicio de Excel.' },
      { name: 'Eliminar Columna', desc: 'Borra permanentemente la columna seleccionada.' }
    ]
  },
  {
    id: 'cleaning',
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-zinc flex items-center gap-2">
                <BookOpen className="text-persian" /> Documentación
              </h1>
              <p className="text-gray-500 dark:text-wolf text-sm mt-1">Guía de referencia de todas las funciones de DataFlow Pro.</p>
            </div>
            ...
            <div className="relative w-full md:w-64">
              ...
              <input 
                type="text" 
                placeholder="Buscar función (ej: Trim)..." 
