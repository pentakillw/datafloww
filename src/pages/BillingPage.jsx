        ...
        <div className="h-full flex items-center justify-center p-6 bg-gray-50/50 dark:bg-black/20">
            <div className="w-full max-w-2xl bg-white dark:bg-carbon rounded-xl shadow-2xl border border-gray-200 dark:border-wolf/10 p-8 text-center animate-in fade-in zoom-in-95 duration-300">
                ...
                <h1 className="text-3xl font-bold text-gray-900 dark:text-zinc flex items-center justify-center gap-3 mb-2">
                    <Crown className="text-yellow-500 fill-yellow-500" size={30} /> {t('billing.title')}
                </h1>
                ...
                <div className="border border-persian/20 rounded-xl p-6 bg-persian/5 dark:bg-persian/10">
                    <p className="text-xl font-bold text-persian mb-2">{t('billing.planTitle')}</p>
                    <p className="text-3xl font-black text-gray-900 dark:text-zinc mb-6">$9.99 <span className="text-base font-normal text-gray-500 dark:text-wolf">{t('billing.perMonth')}</span></p>
                    
                    <ul className="text-left space-y-2 text-gray-700 dark:text-wolf text-sm mb-8">
                        <li className="flex items-center gap-2"><Zap size={16} className="text-sea" /> {t('billing.features.unlimitedExport')}</li>
                        <li className="flex items-center gap-2"><Zap size={16} className="text-sea" /> {t('billing.features.extendedLimits')}</li>
                        <li className="flex items-center gap-2"><Zap size={16} className="text-sea" /> {t('billing.features.prioritySupport')}</li>
                    </ul>
                    ...
                    >
                        <CreditCard size={20} /> {t('billing.payButton')}
                    </button>
                </div>
            </div>
        </div>
